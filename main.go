...
func main() {
	...
	reflection := calculation.ReflectFromSection(models.Vector{From: models.Point{X: 0, Y: 0}, To: models.Point{X: 1, Y: 1}}, models.Vector{From: models.Point{X: 0, Y: 1}, To: models.Point{X: 1, Y: 0}})
